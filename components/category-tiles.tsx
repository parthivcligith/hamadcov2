        ...
        <div className={cn("relative grid grid-cols-2 gap-3", className)}>
          {categories.map((c) => (
            <Link
              ...
              className="relative overflow-hidden rounded-xl group min-h-[80px] shadow-sm hover:shadow-md transition-shadow duration-200 bg-white border border-gray-200"
            >
              <div className="absolute top-2 right-2 text-blue-600 opacity-60">{c.icon}</div>
              <div className="relative p-3 flex flex-col justify-end h-full">
                ...
                <div className="mt-2 w-fit rounded-full px-2.5 py-0.5 text-[11px] font-medium text-blue-600 bg-blue-50 border border-blue-200">
                  Explore
                </div>
              </div>
            </Link>
        ...
        {categories.map((c, i) => {
          ...
          return (
            <Link
              ...
              aria-label={`${c.title} exports`}
              className={cn(
                "relative overflow-hidden rounded-2xl group bg-white border border-gray-200",
            ...
            >
              <div className="absolute top-4 right-4 text-blue-600 opacity-70">{c.icon}</div>
              ...
              <div className="relative p-6 flex flex-col justify-end h-full">
                ...
                <div
                  className={cn(
                    "mt-3 w-fit rounded-full px-3 py-1 text-xs font-medium text-blue-600 bg-blue-50 border border-blue-200",
              ...
              <div
                className={cn(
                  ...
                  isActive ? "ring-4 ring-blue-400/60" : "ring-0",
                )}
              />
            </Link>
          )
